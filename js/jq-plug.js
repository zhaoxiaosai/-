...
$.fn.amazon_scroller=function(p){
        ...
        dom.find(".amazon_scroller_nav").children("li").hover(
            function(){
                ...
                $(this).css("background-position","-85px -103px");
                }
            },
            function(){
                if($(this).parent().children().index($(this))==0){
                $(this).css("background-position","0px -77px");
                }else if($(this).parent().children().index($(this))==1){
                $(this).css("background-position","-85px -77px");
                }
            }
        );
    ...
    c.css('background-position','-85px -77px');
    b.css('background-position','0px -77px');
    c.css('right','0px')
    }
}
